...
### 1. 准备工作
三etcd节点均执行以下操作
+ [01.系统初始化.md](https://github.com/wanilyer/kubeadm/blob/master/01.%E7%B3%BB%E7%BB%9F%E5%88%9D%E5%A7%8B%E5%8C%96.md)
+ [02.安装docker和kubeadm.md](https://github.com/wanilyer/kubeadm/blob/master/02.%E5%AE%89%E8%A3%85docker%E5%92%8Ckubeadm.md)
...
```
主要有两个地方需要注意修改:
+ `--pod-infra-container-image: 修改默认镜像拉取地址`
+ `--cgroup-driver=systemd: 采用系统建议的systemd, 需同时修改docker配置: native.cgroupdriver=systemd`
...
1. kubelet启动不成功——`cgroup driver`问题
```
## 问题原因
